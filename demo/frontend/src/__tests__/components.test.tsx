...
const mockNodes: NodeInfo[] = [
  {
    ...
    violation_rate: 0.0, running_jobs: [
...
describe('HUD', () => {
  it('renders without crashing', () => {
    const { container } = render(<HUD hud={mockHUD} interval={5} />)
    expect(container.firstChild).toBeTruthy()
  })

  it('displays total job count', () => {
    render(<HUD hud={mockHUD} interval={5} />)
  ...
  it('shows interval counter', () => {
    render(<HUD hud={mockHUD} interval={42} />)
...
describe('MemoryWave', () => {
  it('renders with empty history', () => {
    const { container } = render(<MemoryWave history={[]} />)
    expect(container.firstChild).toBeTruthy()
  })

  it('renders with history data', () => {
    const { container } = render(<MemoryWave history={[10, 20, 30, 40, 50]} />)
    expect(container.firstChild).toBeTruthy()
  })

  it('renders correctly at 100% utilization', () => {
    const { container } = render(<MemoryWave history={[100, 100, 100]} />)
    expect(container.firstChild).toBeTruthy()
  })
})
