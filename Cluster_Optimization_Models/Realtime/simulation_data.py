...
class NodeState:
    ...
    overflow_history:  list  = field(default_factory=list)  # used_mb > M_n^cap  (soft: schedulable ceiling exceeded)
    violation_history: list  = field(default_factory=list)  # used_mb > M_n      (hard: physical RAM exceeded)
